                        ...
                        <TeamMembers>
                            <TeamInner>
                                <ImageHolder>
                                    <SocialIconContainer>
                                        <SocialIcon>
                                            <Icon className='icon-lkd'><a><i class="fab fa-linkedin"></i></a></Icon>
                                            <Icon className='icon-ytb'><a><i className="fab fa-youtube"></i></a></Icon>
                                            <Icon className='icon-skp'><a><i className="fab fa-skype"></i></a></Icon>
                                        </SocialIcon>
                                    </SocialIconContainer>
                                    <TeamImage>
                                        <Image src={item.src}/>
                        ...
                        <TeamMembers className="advistors">
                            <TeamInner>
                                ...
                                <ImageHolder>
                                    <SocialIconContainer>
                                        <SocialIcon>
                                            <Icon className='icon-lkd'><a><i className="fab fa-linkedin"></i></a></Icon>
                                            <Icon className='icon-ytb'><a><i className="fab fa-youtube"></i></a></Icon>
                                            <Icon className='icon-skp'><a><i className="fab fa-skype"></i></a></Icon>
                                        </SocialIcon>
                                    </SocialIconContainer>
